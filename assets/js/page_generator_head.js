...
function askForPage(pageUri) {
    ...
    $.ajax({
        ...
        error: function() {
            this.html('<div class="d-flex justify-content-center align-items-center" style="height:100vh;"><div class="display-4 text-muted text-center m-5">Need to deploy on a WebServer to display the content.</div></div>');
        }
    });
